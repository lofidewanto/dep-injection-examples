...
import de.config.AppMockConfig;
...
public class SolutionServiceImplAppMockConfigTest {

	private static final Logger logger = LoggerFactory.getLogger(SolutionServiceImplAppMockConfigTest.class);
